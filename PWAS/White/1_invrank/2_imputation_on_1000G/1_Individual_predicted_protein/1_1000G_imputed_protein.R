...
prot <- read_tsv("/home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/Plasma_Protein_EA_hg38.pos")
...
for (i in 1:nrow(prot)) {
    ...
    genos = read_plink(paste0("/home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/LDref/EUR/chr",chr),impute="avg")
    ...
    load(paste0("/home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/Plasma_Protein_weights_EA/",prot$WGT[i]))
...
write_tsv(as.data.frame(pred_matrix), paste0("/home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_prot.txt"))
