...
prot0 <- read_tsv("/home-2/jzhan218@jhu.edu/data/jzhan218/PWAS/Results/White/Plasma_Protein.pos")
prot1 <- read_tsv("/home-2/jzhan218@jhu.edu/data/jzhan218/PWAS/Results/White/Plasma_Protein_0.05.pos")

prot <- prot1[!(prot1$WGT %in% prot0$WGT),]
...
write_tsv(as.data.frame(pred_matrix), paste0("/home-2/jzhan218@jhu.edu/data/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_prot_new.txt"))


library(readr)
a <- read_tsv("/home-2/jzhan218@jhu.edu/data/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_prot_new.txt")
b <- read_tsv("/home-2/jzhan218@jhu.edu/data/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_prot.txt")
a <- cbind(b,a)
dim(a)
write_tsv(a, "/home-2/jzhan218@jhu.edu/data/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_prot.txt")
