...
pred_matrix = matrix(nrow=498,ncol=length(geneENSG))
...
for (i in 1:length(geneENSG)) {
    ...
    if(sum(m)==0){
        ...
        snps = snps[m,]
        writeLines(snps$V2,
                   paste0("/home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_FUSION/tmp/",tissue,"-",i,".txt"))

        suppressMessages(system(paste0("/home-2/jzhan218@jhu.edu/work/jzhan218/TOOLS/plink/plink2 --bfile /home-2/jzhan218@jhu.edu/work/jzhan218/1000G/GRCh38/EUR/chr",chr," --extract /home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_FUSION/tmp/",tissue,"-",i,".txt --make-bed --out /home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_FUSION/tmp/",tissue,"-",i)))

        # load in genotype files by chromosome, restrict to matching SNPs and combine
        genos = read_plink(paste0("/home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_FUSION/tmp/",tissue,"-",i),impute="avg")
    ...
    system(paste0("rm -rf /home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_FUSION/tmp/",tissue,"-",i,".*"))
...
write_tsv(as.data.frame(pred_matrix), paste0("/home-2/jzhan218@jhu.edu/work/jzhan218/PWAS/Results/White/1000G_imputed/1000G_imputed_FUSION/",tissue,".txt"))
