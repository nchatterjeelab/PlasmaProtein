...
annota.pwas <- read_tsv("/dcs04/nilanjan/data/jzhang2/pwas/PWAS_tutorial/Plasma_Protein_EA_hg38.pos")
...
for (i in 1:length(seq)){
  ...
  a <- read_plink(paste0('/dcs04/nilanjan/data/jzhang2/pwas/pipeline/Results_GRCh38/White/window1M/byseq_remove_ambiguous_snp/', gene))
  b <- t(a$X)
  ...
  if(length(snpid)==0){
    ...
    tmp <- read.table(paste0("/dcl01/chatterj/data/jzhang2/pwas/pipeline/Results_GRCh38/White/pQTL/peernum/invrankpheno/90/",gene,".pheno"))
...
write_tsv(res, paste0("/dcs04/nilanjan/data/jzhang2/pwas/pipeline/Results_GRCh38/CrossEthnic/AAtoEA_Predicted_Accuracy.txt"))
