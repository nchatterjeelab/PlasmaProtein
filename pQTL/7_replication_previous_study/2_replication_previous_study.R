...
replication$repl1 <- as.numeric(replication$p1) < 1.92*10^(-11)
replication$repl2 <- as.numeric(replication$p2) < 1.5*10^(-11)
...
mean((replication$repl1) | (replication$repl2)) # 0.988189
sum((replication$repl1) | (replication$repl2)) # 502
