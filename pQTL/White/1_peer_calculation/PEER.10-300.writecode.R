...
writeLines(a,  paste0("/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/1_peer_calculation/ind_Rout.txt"))
writeLines(b,  paste0("/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/1_peer_calculation/ind_para.txt"))
...
")
writeLines(a, paste0("/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/1_peer_calculation/PEER.sh"))
