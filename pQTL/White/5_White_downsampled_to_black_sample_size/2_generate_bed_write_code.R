...
dir.create("/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/5_White_downsampled_to_black_sample_size/generate_bed/")
...
")
  ...
  writeLines(b,  paste0('/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/5_White_downsampled_to_black_sample_size/generate_bed/', n_peer, '.sh'))
