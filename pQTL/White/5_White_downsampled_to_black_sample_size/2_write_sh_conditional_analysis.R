...
dir.create('/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/5_White_downsampled_to_black_sample_size/')
...
n_peer <- 120
  ...
  dir.create(paste0('/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/5_White_downsampled_to_black_sample_size/',n_peer))
...
cd /dcl01/chatterj/data/jzhang2/pwas/pipeline/Results_GRCh38/White/pQTL/White_matchNblack/all_sample_peers/",n_peer,"/vcf_file
...
")
  ...
  a <- paste0(a, 'cd /dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/5_White_downsampled_to_black_sample_size/',n_peer,'
qsub chr', i, '.sh

')

  writeLines(b,  paste0('/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/5_White_downsampled_to_black_sample_size/',n_peer,'/chr', i, '.sh'))
...
writeLines(a,  paste0('/dcl01/chatterj/data/jzhang2/pwas/pipeline/codes/GRCh38/pQTL/White/5_White_downsampled_to_black_sample_size/all.sh'))
