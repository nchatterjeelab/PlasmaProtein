...
summary.Liver <- readRDS("/Users/jnz/Document/JHU/Research/PWAS/Analysis/1_Heritability/RESULTS/summary.Liver.rds")
summary.Whole_Blood <- readRDS("/Users/jnz/Document/JHU/Research/PWAS/Analysis/1_Heritability/RESULTS/summary.Whole_Blood.rds")
...
pred_acc <- read_tsv("/Users/jnz/Document/JHU/Research/PWAS/Analysis/3_CrossEthnic/EAtoAA_Predicted_Accuracy.txt")
...
mean(pred_acc$acc) # 0.7007525
mean(pred_acc$acc.cross) # 0.4200855

pred_acc <- read_tsv("/Users/jnz/Document/JHU/Research/PWAS/Analysis/3_CrossEthnic/AAtoEA_Predicted_Accuracy.txt")
pred_acc$acc <- pred_acc$rsq/pred_acc$hsq
pred_acc$acc.cross <- pred_acc$rsq.cross/pred_acc$hsq
pred_acc$ratio <- pred_acc$rsq.cross/pred_acc$rsq
...
mean(pred_acc$acc) # 0.9289865
mean(pred_acc$acc.cross) # 0.6679017
